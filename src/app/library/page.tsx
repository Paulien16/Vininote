    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-50">
      <div className="mx-auto max-w-6xl px-6 py-8">
        <div className="mb-6 flex items-end justify-between gap-4">
          ...
          <Link
            href="/tasting/new"
            className="hidden rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-neutral-900 hover:bg-neutral-200 md:inline-flex"
          >
        ...
        {filtered.length === 0 ? (
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 text-neutral-300">
            ...
            <div className="mt-3">
              <Link href="/tasting/new" className="underline text-white/90">
